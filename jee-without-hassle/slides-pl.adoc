...
----
sql2o PojoPerformanceTest :: http://goo.gl/cwNkRN
----
...
* Ale przede wszystkim, jak już leci wyjątek to dokładnie wiemy gdzie :)
====
...
* Powstał dla twittera, tak jak webbit powstał dla DRW Trading (tego od Dana Northa i Joe Walesa)
** Pomiędzy 0.6 a 0.7 podochodziło parę rzeczy, aby dostosować sie do wszystkich
** Nie tylko coda hale
...
Time (to get creative, not operational), confidence (small chunk, we can get to Spring back),
Humor (why, because we can)
